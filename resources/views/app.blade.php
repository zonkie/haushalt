...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('/css/refineslide.css') }}"/>
        <link rel="stylesheet" href="{{ asset('/css/bootstro.css') }}"/>

        <link rel="stylesheet" href="{{ asset('/css/jquery-slider.css') }}"/>
        <link rel="stylesheet" href="{{ asset('/css/checkbox-radio-switch.css') }}"/>
